...
if (tenders[i].getCost() < minCostTender.getCost()) { minCostTender = tenders[i]; } }
System.out.println("\nCompany name for the tender with minimum cost (" + minCostTender.getCost() + "): " + minCostTender.getCompanyName()); } }
